...
open class Localize: NSObject {
     ...
     */
    open class func main(key: String) -> String {
        return key.localized(in: Bundle.main)
    }
    
    public class func toggleLanguage() {
        let key = isEnglish() ? "th" : "en"
        self.setCurrentLanguage(key)
    }
    
    public class func isEnglish() -> Bool {
